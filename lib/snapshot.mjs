 ...
 * @param {Array<object>} entries - 可见条目。
 * @returns {Map<string, object[]>} key = 'track/scope'，值按 createdAt,id 升序。
 */
 ...
 * 空记忆零 token 成本。
 * @param {Array<object>} entries - 会话可见条目。
 * @param {object} budgets - Config.budgets。
 * @returns {string} 快照文本。
 */
