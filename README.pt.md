...
| `panel.enabled` | `true` | Mostrar o botão flutuante do painel web; `false` oculta a entrada 🧠 imediatamente pela página de configurações, sem recarregar (a página de configurações não é afetada) |
